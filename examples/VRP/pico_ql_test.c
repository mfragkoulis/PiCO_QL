...
#ifndef __APPLE__    /* Apple's pre-installed sqlite appears to have broken static checks.
                      * In 10.7, 10.8 SQLITE_OMIT_LOAD_EXTENSION is not defined yet the linker
                      * complains about undefined symbols. Comment the Apple flag and use with caution.
                      */
