...
/*
Marios Fragkoulis
Include definition of structs VTable, Module to gain access at sqlite3 * (database connection) and
char * (virtual table name) of virtual table module via the sqlite3_vtab field.
So far this is not possible because structs VTable, Module is only declared in sqlite3.c.
The declaration is indeed borrowed from sqlite3.c 
*/
